    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sr', models.CharField(max_length=8, verbose_name='日出时间')),
                ('ss', models.CharField(max_length=8, verbose_name='日落时间')),
                ('mr', models.CharField(max_length=8, verbose_name='月出时间')),
                ('ms', models.CharField(max_length=8, verbose_name='月升时间')),
